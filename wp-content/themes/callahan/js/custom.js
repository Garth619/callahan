...
$("ul > li.menu-item-has-children > a[href='#']").removeAttr("href");
	...
	// sidebar
	 ...
	 $('.sidebarbox_inner ul.menu > li.current-menu-ancestor > a, .widget > ul > li.current-menu-ancestor > a').addClass('active');


	 $('.sidebarbox_inner ul.menu > li.menu-item-has-children > a, .widget > ul > li.menu-item-has-children > a').on('click', function(e) {
	...
	// loops through single case results and wraps into sets of the rowCount parameter
	...
	function rowWrap(rowCount) {
		...
		for(var i = 0; i < divs.length; i+=rowCount) {
  		...
  		divs.slice(i, i+rowCount).wrapAll("<div class='row_wrap row_wrap_"+rowCount+"'></div>");
